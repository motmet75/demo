...
/**
 * Append-only, read-optimized entity for table `inventory_history`.
 * <p>
 * - Append-only: new rows are inserted; updates are not expected.
 * - Read-optimized: marked @Immutable so Hibernate treats this as read-only.
 * - No cascade logic: associations are LAZY and no cascade operations are configured.
 */
@Entity
...
public class InventoryHistoryEntity {
    ...
    public boolean equals(Object o) {
        ...
        InventoryHistoryEntity that = (InventoryHistoryEntity) o;
