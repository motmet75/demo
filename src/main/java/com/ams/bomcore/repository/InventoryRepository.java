...
public interface InventoryRepository extends JpaRepository<InventoryEntity, UUID> {
    ...
    @Query("SELECT new com.ams.bomcore.controller.inventory.dto.InventoryViewDTO("
            ...
            + "i.quantityOnHand, i.quantityTotal, i.quantityReserved, i.quantityLocked, i.batchNo, i.contractCode, i.orderToDeduction, m.unit, i.unitPrice, i.currency, i.warehouseImportUnit, i.warehouseImportQuantity, i.bomUnitPerWarehouseUnit, i.warehouseImportUnitPrice, "
