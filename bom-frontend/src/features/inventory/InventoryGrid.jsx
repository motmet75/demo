...
export default function InventoryGrid() {
  ...
  const normalizeInventoryView = (item) => {
    ...
    return {
      ...
      warehouseImportUnit: item.warehouseImportUnit ?? item.warehouse_import_unit ?? '',
      warehouseImportQuantity: item.warehouseImportQuantity ?? item.warehouse_import_quantity ?? '',
      bomUnitPerWarehouseUnit: item.bomUnitPerWarehouseUnit ?? item.bom_unit_per_warehouse_unit ?? '',
      warehouseImportUnitPrice: item.warehouseImportUnitPrice ?? item.warehouse_import_unit_price ?? '',
  ...
  const columns = [
    ...
    { field: 'warehouseImportQuantity', headerName: 'Wh Import Qty', width: 135, type: 'number', valueFormatter: numFmt },
    { field: 'warehouseImportUnit',     headerName: 'Wh Import Unit', width: 135 },
    { field: 'bomUnitPerWarehouseUnit', headerName: 'BOM Qty / Wh Unit', width: 165, type: 'number', valueFormatter: numFmt },
    { field: 'warehouseImportUnitPrice',headerName: 'Wh Unit Price', width: 135, type: 'number', valueFormatter: numFmt },
